...
#        b.exclude_files = 'EyuLibrary-ios/Classes/framework/ABUAdSDK/**/*'
    ...
    s.subspec 'fb_ads_sdk' do |fb_ads_sdk|
        ...
        fb_ads_sdk.dependency 'FBSDKCoreKit','16.3.1'
    ...
    s.subspec 'applovin_max_sdk' do |applovin_max_sdk|
        ...
        applovin_max_sdk.dependency 'FBSDKCoreKit','16.3.1'
    ...
    s.subspec 'fb_login_sdk' do |fb|
        fb.dependency 'FBSDKCoreKit','16.3.1'
        fb.dependency 'FBSDKShareKit','16.3.1'
        fb.dependency 'FBSDKLoginKit','16.3.1'
